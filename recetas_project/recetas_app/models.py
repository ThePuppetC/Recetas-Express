...
class Receta(models.Model):
    ...
    imagen = models.ImageField(upload_to='recetas/images/%Y/%m/%d/')
    imagen_numero = models.IntegerField(default=0, db_index=True)
    imagen_ancho = models.IntegerField(default=0)
    imagen_alto = models.IntegerField(default=0)
    imagen_size_kb = models.IntegerField(default=0)
